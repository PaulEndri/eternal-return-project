...
export declare class ItemScraper extends CoreScraper {
     ...
     */
    getWeapons: (complete?: boolean) => Promise<Record<string, {
        name: string;
     ...
     */
    getConsumables: (complete?: boolean) => Promise<{
        food: {
            [k: string]: any;
        };
        beverage: {
     ...
     */
    getMaterials: (complete?: boolean) => Promise<{
        [k: string]: any;
    }>;
    /**
     * @param complete if true, also fetch details for each item
     */
    getAll: (complete?: boolean) => Promise<{
        materials: {
            [k: string]: any;
        };
